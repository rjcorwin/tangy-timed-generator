...
(function() {
  ...
  class TangyToggleButton extends HTMLElement {
    static get name() {
      return this._name
    }
     ...
     * document.createElement('tangy-toggle-button'), or calling new TangyToggleButton();
  ...
  window.customElements.define('tangy-toggle-button', TangyToggleButton);
})();
